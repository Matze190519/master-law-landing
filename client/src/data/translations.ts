export const translations = {
  EN: {
    ...
    package2Title: "Company Formation & Tax",
    package2Desc: "International corporate structures and tax optimization models. Dubai Freezone (0% Tax) and Spain.",
  ...
  DE: {
    ...
    package2Title: "Firmengründung & Steuern",
    package2Desc: "Internationale Firmenstrukturen und Steuersparmodelle. Dubai Freezone (0% Steuer) und Spanien.",
  ...
  ES: {
    ...
    package2Title: "Creación de Empresas y Fiscalidad",
    package2Desc: "Estructuras corporativas internacionales y modelos de optimización fiscal. Dubai Freezone (0% Impuestos) y España.",
